        ...
        <span>
          <div class="ai-chat-content" v-for="(item, index) in data" :key="index">
            ...
            <div v-else class="ai-content content">
              <img :src="agentId ? `/imgs/${agentId}.jpg` : '/robot.webp'" alt="" />
...
import digiAiDefaultCopy from "views/digiAi/default copy.vue";
...
export default {
  ...
  components: { digiAiDefault, digiAiDefaultCopy, digiLoading },
  data() {
    return {
